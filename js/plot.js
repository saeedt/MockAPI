  ...
  toImageButtonOptions: {
    ...
    $.get(url).done(function (data) {    	
    	...
    	const pdata = [{'x' : xdata,                  
                  ...
                  'mode' : 'lines'}];
    	Plotly.newPlot('div1',[pdata[0],pdata[1]],{legend:{x:1,xanchor:'right',y:1.1,orientation:'h',font:{size:20}},title:{text:'Data From Mockaroo',font:{size:32}},xaxis:{title:{text:'X',font:{size:24}},dtick:1},yaxis:{title:{text:'Y',font:{size:24}}}},config);
